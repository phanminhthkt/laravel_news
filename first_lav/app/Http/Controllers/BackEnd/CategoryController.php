...
class CategoryController extends Controller
{
    ...
    {
        $page_name = "List Category";
        $data = Category::all();
        return view('back-end.category.list',compact('page_name','data'));
    }
    ...
    public function create()
    {
        ...
        return view('back-end.category.add',compact('page_name'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $category->status = 1;
        $category->save();
        return redirect()->action('BackEnd\CategoryController@index')->with("success","Category Created Successfully"); //  generates session variable $success
    }
