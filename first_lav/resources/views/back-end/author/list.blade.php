        ...
        @endif
          <div class="card">
              <div class="card-header">
                  ...
                  <a href="{{route('AuthorCreate')}}" class="btn btn-primary pull-right">Create</a>
              </div>
              <div class="card-body">
        <table id="bootstrap-data-table" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-primary" href="{{route('AuthorUpdate',$row->id)}}">Edit</a>
                <!-- <a class="btn btn-danger" href="{{route('PermissionDelete',$row->id)}}">Delete</a> -->
                {{ Form::open(['method'=>'DELETE','url'=>['/backend/author/delete/'.$row->id],'style'=>'display:inline']) }}
