...
<div class="row">
    <div class="col-md-6">
        <div class="category_article_body">
            <div class="top_article_img">
                <img class="img-fluid" src="{{asset('public/front-end')}}/img/category_img1.jpg" alt="feature-top">
            </div>
            <!-- top_article_img -->
    ...
    <div class="col-md-6">
        <div class="category_article_body">
            <div class="top_article_img">
                <img class="img-responsive" src="{{asset('public/front-end')}}/img/category_img2.jpg" alt="feature-top">
            </div>
            <!-- top_article_img -->
...
<div class="row">
    <div class="col-md-6">
        <div class="category_article_body">
            <div class="top_article_img">
                <img class="img-responsive" src="{{asset('public/front-end')}}/img/category_img3.jpg" alt="feature-top">
            </div>
            <!-- row -->
    ...
    <div class="col-md-6">
        <div class="category_article_body">
            <div class="top_article_img">
                <img class="img-responsive" src="{{asset('public/front-end')}}/img/category_img4.jpg" alt="feature-top">
            </div>
            <!-- top_article_img -->
...
<div class="row">
    <div class="col-md-6">
        <div class="category_article_body">
            <div class="top_article_img">
                <img class="img-responsive" src="{{asset('public/front-end')}}/img/category_img5.jpg" alt="feature-top">
            </div>
            <!-- top_article_img -->
    ...
    <div class="col-md-6">
        <div class="category_article_body">
            <div class="top_article_img">
                <img class="img-responsive" src="{{asset('public/front-end')}}/img/category_img6.jpg" alt="feature-top">
            </div>
            <!-- top_article_img -->
...
<div class="row">
    <div class="col-md-6">
        <div class="category_article_body">
            <div class="top_article_img">
                <img class="img-responsive" src="{{asset('public/front-end')}}/img/category_img7.jpg" alt="feature-top">
            </div>
            <!-- top_article_img -->
    ...
    <div class="col-md-6">
        <div class="category_article_body">
            <div class="top_article_img">
                <img class="img-responsive" src="{{asset('public/front-end')}}/img/category_img8.jpg" alt="feature-top">
            </div>
            <!-- top_article_img -->
