...
<div class="entity_wrapper">
    ...
    <div class="entity_thumb">
        <img class="img-responsive" src="{{asset('public/front-end/')}}/img/category_img_top.jpg" alt="feature-top">
    </div>
    <!-- entity_thumb -->
...
<div class="widget_advertisement">
    <img class="img-responsive" src="{{asset('public/front-end/')}}/img/category_advertisement.jpg" alt="feature-top">
</div>
<!--Advertisement-->
...
<div class="readers_comment">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#">
                <img alt="64x64" class="media-object" data-src="{{asset('public/front-end/')}}/img/reader_img1.jpg"
                     src="{{asset('public/front-end/')}}/img/reader_img1.jpg" data-holder-rendered="true">
            </a>
        </div>
        <div class="media-body">
            ...
            <div class="media">
                <div class="media-left">
                    <a href="#">
                        <img alt="64x64" class="media-object" data-src="{{asset('public/front-end/')}}/img/reader_img2.jpg"
                             src="{{asset('public/front-end/')}}/img/reader_img2.jpg" data-holder-rendered="true">
                    </a>
                </div>
                <div class="media-body">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#">
                <img alt="64x64" class="media-object" data-src="{{asset('public/front-end/')}}/img/reader_img3.jpg"
                     src="{{asset('public/front-end/')}}/img/reader_img3.jpg" data-holder-rendered="true">
            </a>
        </div>
        <div class="media-body">
